...
// //2020/9/2 updata timer for switching
// void Init_Timer2(void)
// {
//      T2CONbits.TON      =1; //enable Timer2
//      T2CONbits.TCKPS    =0; //1;1
//      T2CONbits.TGATE    =0; //Disable Gate Time Accumulation Mode
//      T2CONbits.TCS      =0; //Select internal clock as the timer clock source
//      T2CONbits.TSIDL    =0; //Continues module operation in Idle mode
     
//      IFS0bits.T2IF=0;    //Timer2 Flag clear
//      IEC0bits.T2IE=1;    //Timer2 enable
//      IPC1bits.T2IP=6;  //Timer2 priority
...
// {
//    if( IFS0bits.T2IF==1)     // flag equl to 1  
//    { 
//        Key=1;
//        Excheck_LAT=!Excheck_LAT;
