...
//2020/9/4 updata for output Vac part 
...
//2020/9/4 user define as Table0~2 as Input part display
...
//2020/9/4 user define as 3~5
void LCM_TABLE3(unsigned char select_mode)
{
    switch(select_mode)
    {    /*SEG & COM*/  
       case 0: //parameter
    ...
    CS_LAT=0;
    sentdata(0x5,0xD,ADC_Vaules.COM_REG_1,10);       
    CS_LAT=1;
    __delay_ms(1);
    
    CS_LAT=0;
    sentdata(0x5,0xE,ADC_Vaules.COM_REG_2,10);       
    CS_LAT=1;
    __delay_ms(1);   
}
//Interger showing
void LCM_TABLE4(unsigned char select_mode)
{
    switch(select_mode)
    {    /*SEG & COM*/  
        case 0: //parameter
    ...
    CS_LAT=0;
    sentdata(0x5,0xF,ADC_Vaules.COM_REG_1,10);       
    CS_LAT=1;
    __delay_ms(1);
    
    CS_LAT=0;
    sentdata(0x5,0x10,ADC_Vaules.COM_REG_2,10);       
    CS_LAT=1;
    __delay_ms(1);   
}

//Floating showing here
void LCM_TABLE5(unsigned char select_mode)
{
    switch(select_mode)
    {    /*SEG & COM*/  
       case 0: //parameter
     ...
     CS_LAT=0;
    sentdata(0x5,0x11,ADC_Vaules.COM_REG_1,10);       
    CS_LAT=1;
    __delay_ms(1);
    
    CS_LAT=0;
    sentdata(0x5,0x12,ADC_Vaules.COM_REG_2,10);       
    CS_LAT=1;
    __delay_ms(1);
}